...
func (app *application) invalidAuthenticationTokenResponse(w http.ResponseWriter, r *http.Request) {
	// We’re including a WWW-Authenticate: Bearer header here to help inform
	// or remind the client that we expect them to authenticate using a bearer token.
...
func (app *application) requireActivatedUserResponse(w http.ResponseWriter, r *http.Request) {
